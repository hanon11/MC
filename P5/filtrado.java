...
public class filtrado
{
    ...
    public static void main( String[] args ) 
    {
        for( int i = 0; i < 255; i++ ) //reglas
        {
            ...
            if( (double)ceros/generaciones != 0 )
            ...
            H = -H;
            if( (double)(sumatorio_hamming/generaciones) > 300 && (double)sumatorio_entropia/generaciones > 0.8 && (double)H > 0.8 )
            {
                FileWriter fichero = null;
                PrintWriter pw = null;
                try
                {
                    fichero = new FileWriter("reglas.txt", true);
